...
class ListItem:
    ...
    def get_properties(self, request_item):
        ...
        if request_item.get('genres'):
            self.infoproperties = lib.utils.iter_props(request_item.get('genres'), 'Genre', self.infoproperties, name='name', tmdb_id='id')
        if request_item.get('production_companies'):
            self.infoproperties = lib.utils.iter_props(request_item.get('production_companies'), 'Studio', self.infoproperties, name='name', tmdb_id='id')
        if request_item.get('production_countries'):
            self.infoproperties = lib.utils.iter_props(request_item.get('production_countries'), 'Country', self.infoproperties, name='name', tmdb_id='id')
