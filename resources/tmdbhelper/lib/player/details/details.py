...
class PlayerDetailedItemDict(dict):
...
class PlayerDetailedItemDictMovie(PlayerDetailedItemDict):
...
class PlayerDetailedItemDictEpisode(PlayerDetailedItemDict):
    tmdb_type = 'tv'
...
def PlayerDetailedItemDictFactory(tmdb_type, tmdb_id, season=None, episode=None, details=None):
    itemdict = (
