...
def _get_basedir_random():
    return [
        ...
        {
            'label': u'{} {{item_type}}{{space}}{}'.format(
                get_localized(590), get_localized(32411)),
            'types': ['movie', 'tv'],
        ...
        {
            'label': u'{} {{item_type}}{{space}}{}'.format(
                get_localized(590), get_localized(705)),
            'types': ['tv'],
        ...
        {
            'label': u'{} {{item_type}}{{space}}{}'.format(
                get_localized(590), get_localized(572)),
            'types': ['movie'],
...
def get_basedir_details(tmdb_type, tmdb_id, season=None, episode=None, detailed_item=None, include_play=False):
    ...
    if tmdb_type == 'movie':
        ...
        base_item['infolabels']['mediatype'] = 'person'
...
class ListDetails(ContainerDirectory):
    def get_items(self, tmdb_type, tmdb_id, season=None, episode=None, **kwargs):
        ...
        self.lidc.cache_refresh = None
        detailed_item = self.lidc.get_item(tmdb_type, tmdb_id, season, episode)
        return get_basedir_details(tmdb_type, tmdb_id, season, episode, detailed_item)
