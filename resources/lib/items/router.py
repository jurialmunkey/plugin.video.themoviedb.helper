...
Container = None  # resources.lib.items.container
...
class Router():
    ...
    @lazyimport_module(globals(), 'resources.lib.items.container', import_attr='Container')
    def get_directory(self):
        container = Container(self.handle, self.paramstring, **self.params)
