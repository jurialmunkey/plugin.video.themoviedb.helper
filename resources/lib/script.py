...
class Script(Plugin):
    ...
    def call_service(self):
        ...
        if 'type=person' in self.added_path:
            ...
            casttmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb.cast)')
            crewtmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb.crew)')
            tmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb)')
            movies_casttmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb.moviescast)')
            movies_crewtmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb.moviescrew)')
            movies_tmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb.movies)')
            tvshows_casttmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb.tvshowscast)')
            tvshows_crewtmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb.tvshowscrew)')
            tvshows_tmdb_numitems = xbmc.getInfoLabel('Container(9999).ListItemAbsolute(0).Property(numitems.tmdb.tvshows)')
            ...
            self.home.setProperty('{}.NumItems.TMDB.Cast'.format(self.prefixcurrent), casttmdb_numitems)
            self.home.setProperty('{}.NumItems.TMDB.Crew'.format(self.prefixcurrent), crewtmdb_numitems)
            self.home.setProperty('{}.NumItems.TMDB'.format(self.prefixcurrent), tmdb_numitems)
            self.home.setProperty('{}.NumItems.TMDB.MoviesCast'.format(self.prefixcurrent), movies_casttmdb_numitems)
            self.home.setProperty('{}.NumItems.TMDB.MoviesCrew'.format(self.prefixcurrent), movies_crewtmdb_numitems)
            self.home.setProperty('{}.NumItems.TMDB.Movies'.format(self.prefixcurrent), movies_tmdb_numitems)
            self.home.setProperty('{}.NumItems.TMDB.TvShowsCast'.format(self.prefixcurrent), tvshows_casttmdb_numitems)
            self.home.setProperty('{}.NumItems.TMDB.TvShowsCrew'.format(self.prefixcurrent), tvshows_crewtmdb_numitems)
            self.home.setProperty('{}.NumItems.TMDB.TvShows'.format(self.prefixcurrent), tvshows_tmdb_numitems)
        else:
            self.home.clearProperty('{}.NumItems.DBID.Movies'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.DBID.TvShows'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.DBID.Episodes'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.DBID'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB.Cast'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB.Crew'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB.MoviesCast'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB.MoviesCrew'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB.Movies'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB.TvShowsCast'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB.TvShowsCrew'.format(self.prefixcurrent))
            self.home.clearProperty('{}.NumItems.TMDB.TvShows'.format(self.prefixcurrent))
